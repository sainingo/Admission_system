                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input type="text" name="firstname" class="form-control" value= "<?php echo $details[1]; ?> " disabled>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>LastName</label>
                                            <input type="text" name="lastname" class="form-control" value= "<?php echo $details[2]; ?> " disabled>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Gender</label>
                                            <input list="gender" name="gender" class="form-control" value= "<?php echo $details[3]; ?> " disabled>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 form-group">
                                            ...
                                            <input type="text" name="dob" class="form-control" value= "<?php echo $details[11]; ?> " disabled>
                                        </div>
                                        ...
                                        <div class="col-sm-3 form-group">
                                            <label>Town</label>
                                            <input type="text" name="town" class="form-control" value= "<?php echo $details[6]; ?> " disabled>
                                        </div>
