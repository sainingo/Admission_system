...
<div class="row">
    <div class="col-md-4 col-md-offset-2">
          <a href="register.php"><button class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;CREATE ACCOUNT</button></a>

          </div>

    <div class="col-md-4">
        <a href="#login" data-toggle="modal" class="navbar-brand" data-target="#login-modal"><button class="btn btn-primary"><span class="glyphicon glyphicon-lock"></span>&nbsp;&nbsp; LOGIN</button></a>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <a href="register.php"><button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-ok"></i> Proceed to Application</button></a>
                                  </div>
                                </div>
                                <!-- /.modal-content -->
                              </div>
